...
def error_response(
    *,
    ...
    error = ErrorBody(code=code, message=message, details=details, upstream=upstream)
    return {"success": False, "error": error.model_dump(exclude_none=True)}
